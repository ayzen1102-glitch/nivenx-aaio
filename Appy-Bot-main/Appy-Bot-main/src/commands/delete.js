...
import { deleteTicketChannel } from "../lib/ticket-helpers.js";
...
const command = {
  data: new SlashCommandBuilder()
    .setName("delete")
    .setDescription("Permanently delete this ticket channel (staff only)"),
  ...
  async execute(interaction) {
    ...
    confirmContainer.addTextDisplayComponents(
      new TextDisplayBuilder().setContent(
        "## 🗑️ Delete Ticket\nAre you sure? This will **permanently delete** this channel and cannot be undone."
      )
    );
    ...
    try {
      ...
      if (btn.customId === "delete_confirm") {
        ...
        await btn.update({
          components: [box("Cancelled — channel not deleted.")],
